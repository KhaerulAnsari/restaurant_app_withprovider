...
class TypografyStyle {
  // Color
  static Color mainColor = const Color(0xFFFF815E);
  static Color blackColor = const Color(0xFF212131);
  static Color greyColor = const Color(0xFFCBCCD5);
  static Color cardColor = const Color(0xFFAAAAAC);
  static Color whiteColor = const Color(0xFFEFFFFF);
